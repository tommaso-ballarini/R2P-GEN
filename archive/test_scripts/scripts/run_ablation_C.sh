#!/bin/bash
#SBATCH --job-name=r2p_ablation_C
...
#SBATCH --output=logs/ablation_C/%j.out
#SBATCH --error=logs/ablation_C/%j.err
...
OUTPUT_DIR=/leonardo_work/IscrC_MUSE/tballari/FM_Data/output/ablation_full_C_image_text_naive
