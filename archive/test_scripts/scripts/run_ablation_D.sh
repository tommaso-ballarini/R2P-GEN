#!/bin/bash
#SBATCH --job-name=r2p_ablation_D
...
#SBATCH --output=logs/ablation_D/%j.out
#SBATCH --error=logs/ablation_D/%j.err
...
OUTPUT_DIR=/leonardo_work/IscrC_MUSE/tballari/FM_Data/output/ablation_full_D_image_fingerprints_norefine
