...
echo "Stima tempo: ~$((N_GENERATED * 150 / 60)) minuti per $N_GENERATED concetti"

# ===========================================================================
# 4. Final Judge
# ===========================================================================
echo "Avvio final_judge su $N_GENERATED concetti..."
START=$(date +%s)
...
END=$(date +%s)
echo "⏱️  Tempo final_judge: $((END - START))s  ($((( END - START ) / 60))m)"

# ===========================================================================
# 5. Verifica output + distribuzione score
# ===========================================================================
echo ""
echo "--- Output check ---"
...
print()
print('   Usa analyze_judge_scores.py per la distribuzione completa.')
"
else
