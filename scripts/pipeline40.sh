#!/bin/bash
#SBATCH --job-name=r2p_pipeline_40
...
#SBATCH --output=logs/pipeline_40/%j.out
#SBATCH --error=logs/pipeline_40/%j.err
...
# ===========================================================================
# 3. Build database (40 concetti)
# ===========================================================================
echo ""
echo "=========================================================="
echo "STAGE 1/3 — BUILD DATABASE (40 concetti)"
echo "=========================================================="
START=$(date +%s)
...
# ===========================================================================
# 4. Generate (40 concetti)
# ===========================================================================
echo ""
echo "=========================================================="
echo "STAGE 2/3 — GENERATE (40 concetti)"
echo "=========================================================="
START=$(date +%s)
...
# ===========================================================================
# 5. Verify (40 concetti)
# ===========================================================================
echo ""
echo "=========================================================="
echo "STAGE 3/3 — VERIFY (40 concetti)"
echo "=========================================================="
START=$(date +%s)
